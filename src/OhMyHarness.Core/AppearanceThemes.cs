...
public static class AppearanceThemes
{
    public static IReadOnlyList<AppearanceTheme> All { get; } = [
        ...
        // Airbus Blue #00205B, with derived tints for accessible application surfaces.
        // https://www.brand.airbus.com/en/asset-library/airbus-logo
        new("fly-dark", "Fly dark", "Fly dark", true, "#001330", "#00205B", "#FFFFFF", "#B5C9E4", "#83C6E8"),
        new("fly-light", "Fly light", "Fly light", false, "#EEF3FA", "#FFFFFF", "#00205B", "#52647E", "#00205B")
    ];
