...
public static class SourceTools
{
    ...
    public static void AddDefinitions(JsonArray definitions, bool sources, string skills)
    {
        ...
        if (Skills.Enabled(skills, "code_search"))
        {
            ...
            Add("grep_sources", "Search project text files with path:line results. Literal by default; regex=true for regex. glob defaults to **/*. Files >128 KB and unsupported formats are skipped.", new() {
