...
public static class Skills
{
    public static IReadOnlyList<SkillDefinition> All { get; } = [
        ...
        new("keyboard_control", "Contrôle du clavier", "Keyboard control", "Saisir du texte et utiliser des raccourcis dans Windows ou le navigateur après autorisation.", "Type text and use keyboard shortcuts in Windows or the browser after approval.", "Use desktop_keyboard or browser_keyboard only when keyboard interaction is necessary. State the intended text field or shortcut target and respect any denial."),
