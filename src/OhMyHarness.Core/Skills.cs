...
public static class Skills
{
    public static IReadOnlyList<SkillDefinition> All { get; } = [
        ...
        new("screenshots", "Captures d’écran", "Screenshots", "Capturer le bureau ou la page du navigateur et transmettre l’image au modèle après autorisation.", "Capture the desktop or browser page and send the image to the model after approval.", "Use desktop_screenshot or browser_screenshot when the screen must be understood visually. The tool requests permission before transmitting the capture."),
