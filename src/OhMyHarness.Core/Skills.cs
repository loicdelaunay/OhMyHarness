...
public static class Skills
{
    public static IReadOnlyList<SkillDefinition> All { get; } = [
        ...
        new("mouse_control", "Contrôle de la souris", "Mouse control", "Déplacer, cliquer et faire défiler sur le bureau Windows ou dans le navigateur après autorisation.", "Move, click and scroll on the Windows desktop or in the browser after approval.", "Use desktop_mouse or browser_mouse only when visual coordinate interaction is necessary. Describe the intended target precisely and respect any denial."),
