...
<p align="center">
  <a href="https://github.com/loicdelaunay/OhMyHarness/releases/tag/v1.11.0">Download GUI</a>
  · <a href="https://github.com/loicdelaunay/OhMyHarness/releases/tag/cli-v1.11.0">Download CLI</a>
...
See the [full changelog](CHANGELOG.md) for version-by-version details. Both current downloads include their applicable changes through v1.11.0.
...
1. Download the [GUI release](https://github.com/loicdelaunay/OhMyHarness/releases/tag/v1.11.0), or choose the [CLI release](https://github.com/loicdelaunay/OhMyHarness/releases/tag/cli-v1.11.0) for a terminal workspace. Select the archive for your OS and CPU.
